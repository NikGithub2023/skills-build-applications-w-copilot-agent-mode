...
>
> ```prompt
> Let's add the following to a prompt file called `update-octofit-tracker-app.prompt.md` in the `.github/prompts` directory and add agent: 'agent' and model: GPT-4.1 to the prompt file.
>
> # Django App Updates
>
